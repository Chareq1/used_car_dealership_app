...
public partial class VehicleUpdateView : UserControl
{
    // Digits
    ...
    {
        if (!Letters.Contains(e.Key) && !Digits.Contains(e.Key) && e.Key != Key.OemMinus && e.Key != Key.Space && e.Key != Key.OemPeriod && e.Key != Key.Back)
        {
            e.Handled = true;
        }
    }
